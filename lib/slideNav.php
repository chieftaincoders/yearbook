        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="contactUs/email.php">Emails</a></li>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4ff17589278d8b3a"></script>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="sports/cheerleading.php">Cheerleading</a></li>
                    <li><a href="sports/crossCountry.php">Cross Country</a></li>
                    <li><a href="sports/football.php">FootBall</a></li>
                    <li><a href="sports/golf.php">Golf</a></li>
                    <li><a href="sports/softball.php">SoftBall</a></li>
                    <li><a href="sports/track.php">Track</a></li>
                    <li><a href="sports/volleyball.php">VolleyBall</a></li>
                    <li><a href="sports/wrestling.php">Wrestling</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="departments/administration.php">Administration</a></li>
                    <li><a href="departments/english.php">English</a></li>
                    <li><a href="departments/math.php">Mathematics</a></li>
                    <li><a href="departments/science.php">Science</a></li>
                    <li><a href="departments/socialStudies.php">Social Studies</a></li>
                    <li><a href="departments/electives.php">Electives</a></li>
                    <li><a href="departments/specialEducation.php">Special Education</a></li>
                    <li><a href="departments/guidance.php">Guidance</a></li>
                    <li><a href="departments/supprtStaff.php">Support Staff</a></li>
                </ul>
            </li>
        </ul>
